        ...
        <div>
            <div class="user__details">
                <div class="input__box">
                    ...
                    <input type="text" style=" margin-bottom: 20px;" id="secteur" name="secteur"
                        placeholder="secteur">
                </div>
                ...
                <div class="new-container">
                    <div class="new-header">
                        ...
                        <svg id="uploaded-svg" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <input id="file"  type="file" onchange="displayImage(this)">
                </div>
